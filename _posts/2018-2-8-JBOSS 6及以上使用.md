...
![Alt text]({{ site.baseurl }}/assets/images/jboss/1518070890008.png)

输入数据源名称和JNDI名称。
![Alt text]({{ site.baseurl }}/assets/images/jboss/1518071486550.png)


选择数据库驱动
![Alt text]({{ site.baseurl }}/assets/images/jboss/1518071070176.png)
输入连接信息
![Alt text]({{ site.baseurl }}/assets/images/jboss/1518071104243.png)
测试连接
![Alt text]({{ site.baseurl }}/assets/images/jboss/1518071563530.png)
